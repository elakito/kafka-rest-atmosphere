...
==== Consume messages from a specific partion (Binary Mode)
...
.Sample Request (consume message with offset 45 from partion 0 of topic "test")
----
...
==== Consume messages from a specific partion (JSON Mode)
...
.Sample Request (consume message with offset 45 from partion 0 of topic "jsontest")
----
...
.Sample Request (commiting the offsets for consumer "my_instance" at consumer group "my_consumer_group")
----
