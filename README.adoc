...
- 0.0.3-SNAPSHOT
     ** made the detached mode can be configured per connection
     ** switch to use atmosphere-2.4.6-SNAPSHOT to support the chunked request handling that can be configured per connection.
     ** switch to use kafka-rest-atmosphere-2.0.1-elakito-03-SNAPSHOT to support aggregation of records for the subscription mode
