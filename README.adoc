...
The shell scripts bin/kafka-rest-atmosphere-start and bin/kafka-rest-atmosphere-stop 
can be used to start or stop the standalone server, respectively.
